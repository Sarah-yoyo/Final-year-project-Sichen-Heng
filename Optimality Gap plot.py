...
# ARO optimality gaps
aro = {
    'I':   np.array([[0.50, 2.01, 1.04, 0.72, 1.18, 1.49],
                     [0.45, 1.71, 0.99, 1.01, 1.07, 0.82],
                     [0.88, 0.82, 0.96, 1.21, 1.11, 0.86],
                     [1.73, 0.72, 1.20, 0.91, 2.29, 1.48]]),
    'II':  np.array([[0.10, 0.33, 1.04, 0.58, 0.82, 0.40],
                     [1.06, 1.09, 1.01, 1.09, 1.16, 0.53],
                     [0.85, 0.78, 0.67, 1.37, 1.20, 0.16],
                     [1.65, 0.77, 1.67, 1.41, 0.97, 1.95]]),
    'III': np.array([[0.46, 0.75, 0.74, 0.89, 0.38, 1.45],
                     [1.29, 1.75, 1.07, 2.50, 1.18, 0.44],
                     [0.82, 1.90, 1.28, 2.68, 1.01, 0.61],
...
print("Done. Four files saved: optimality_gap_ph.pdf/.png and optimality_gap_aro.pdf/.png")